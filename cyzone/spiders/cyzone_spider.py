...
class CyzoneSpider(CrawlSpider):
	...
	rules = (
        Rule(LinkExtractor(allow=r'%E6%AF%8F%E6%97%A5%E8%9E%8D%E8%B5%84%E6%B8%85%E5%8D%95'), callback='parse_item', follow=True),
    )
	...
	def parse_item(self, response):
		...
		item['content'] = soup.find('div', id='article-content')
		yield item
		# url = response.url
